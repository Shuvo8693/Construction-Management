...
import 'package:charteur/core/widgets/custom_map/reusable_map.dart';
import 'package:charteur/services/google_api_service.dart';
...
class _LocationSelectionMapViewState extends State<LocationSelectionMapView> {
  ...
  Future<BitmapDescriptor> bitmapDescriptorFromSvgAsset([
    ...
    final pictureInfo = await vg.loadPicture(
      SvgAssetLoader('assets/images/nav_pin.svg'),
      null,
    );
